...
namespace LieDetector3
{
    public partial class Form1 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            ROOT=ROOT+"\\"+ DateTime.Now.ToString("yyyyMMddHHmmss")+"\\";
        ...
        {
            var pair = await SpeechRecognization.ContinuousRecognitionWithFileAsync(ROOT);
            //var pair = new KeyValuePair<string, double>("teststr", 10.0);
        ...
        private async void Button6_Click(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(pair_cv.Item1 + " " + pair_cv.Item2);
            pictureBox1.Image = Image.FromFile(ROOT + @"\Image_" + pair_cv.Item1.ToString() + ".jpg");

            double score2 = pair_cv.Item2;
            LyingScoreBox2.Text = Math.Round(score2, 2) + "";
            if (score2 < 40)
            {
                LyingScoreBox2.ForeColor = Color.Green;
            ...
            {
                //MessageBox.Show("You may be lying!");
                LyingScoreBox2.ForeColor = Color.Yellow;
            }
            else
            {
                //MessageBox.Show("You are lying!!!");
                LyingScoreBox2.ForeColor = Color.Red;
            }
        }
